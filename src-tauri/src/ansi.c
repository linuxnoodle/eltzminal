...
pelem parseInsert(char *s) {
  ...
  for (pos = 0; pos < 1024; pos++) {
    ...
    if (s[pos] == ';' || s[pos] == ':' || s[pos] == 0) {
      ...
      if (s[pos] == 0)
        break;
    } else if (digitcount < sizeof(digit)) {
...
enum ColorScheme { SCHEME_WHITE, SCHEME_BLACK, SCHEME_PINK };
...
struct Options parseArgs(int argc, char *args[]) {
  ...
  for (int p = 1; p < argc; p++) {
    if ((strcmp(args[p], (char *)"--help") == 0) ||
        (strcmp(args[p], (char *)"-h") == 0) ||
        (strcmp(args[p], (char *)"-?") == 0)) {
      VERSION_PRINTF_MAKRO
      printf("\033[1maha\033[0m takes SGR-colored Input and prints W3C conform "
             "HTML-Code\n");
      printf("use: \033[1maha\033[0m <\033[4moptions\033[0m> [\033[4m-f "
             "file\033[0m]\n");
      printf("     \033[1maha\033[0m "
             "(\033[4m--help\033[0m|\033[4m-h\033[0m|\033[4m-?\033[0m)\n");
      printf("\033[1maha\033[0m reads the Input from a file or stdin and "
             "writes HTML-Code to stdout\n");
      printf("\033[4mOptions\033[0m:\n");
      printf("      --black,       -b: \033[1;30m\033[1;47mBlack\033[0m "
             "Background and \033[1;37mWhite\033[0m \"standard color\"\n");
      printf("      --pink,        -p: \033[1;35mPink\033[0m Background\n");
      printf("      --style X,   -y X: Set the style used in the <body> "
             "element\n");
      printf("      --stylesheet,  -s: Use a stylesheet instead of inline "
             "styles\n");
      printf("      --iso X,     -i X: Uses ISO 8859-X instead of utf-8. X "
             "must be 1..16\n");
      printf("      --title X,   -t X: Gives the html output the title \"X\" "
             "instead of\n");
      printf("                         \"stdin\" or the filename\n");
      printf("      --lang X,    -L X: Uses the ISO 639-1 code X for the "
             "language\n");
      printf("      --line-fix,    -l: Uses a fix for inputs using control "
             "sequences to\n");
      printf("                         change the cursor position like htop. "
             "It's a hot fix,\n");
      printf("                         it may not work with any program like "
             "htop. Example:\n");
      printf("                         \033[1mecho\033[0m q | "
             "\033[1mhtop\033[0m | \033[1maha\033[0m -l > htop.htm\n");
      printf("      --word-wrap,   -w: Wrap long lines in the html file. This "
             "works with\n");
      printf("                         CSS3 supporting browsers as well as "
             "many older ones.\n");
      printf("      --no-header,   -n: Don't include header into generated "
             "HTML,\n");
      printf("                         useful for inclusion in full HTML "
             "files.\n");
      printf("      --no-xml,      -x: Don't use doctype xml but html (may "
             "useful for old \n");
      printf("                         browsers like IE)\n");
      printf("      --css X,     -c X: Add css file X to the output. In fact "
             "just adds \n");
      printf("                         <link rel=\"stylesheet\" href=\"X\" /> "
             "to the header.\n");
      printf("      --ignore-cr,   -r: Ignore all carriage-returns (ASCII sign "
             "13, \\r)\n");
      printf("                         which may lead to double new lines in "
             "html.\n");
      printf("\033[4mExamples\033[0m:\n");
      printf("          Create an HTML file with a black background, a custom "
             "title and\n");
      printf("          a larger font-size using \033[1maha\033[0m's help:\n");
      printf("\n");
      printf("            \033[1;3;33m$\033[0m \033[1maha\033[0m -h | "
             "\033[1maha\033[0m -b -t '\033[1maha\033[0m help' -y "
             "'font-size:1.8em' > \033[1maha\033[0m-help.html\n");
      printf("\n");
      printf("          Create an HTML file with a white background using the "
             "output of \033[3mdiff\033[0m\n");
      printf("\n");
      printf("            \033[1;3;33m$\033[0m diff -u --color=always "
             "oldfile.c newfile.c | \033[1maha\033[0m > diff.html\n");
      printf("\n");
      printf("          Create an HTML file with a black background from the "
             "output of \033[3mhtop\033[0m.\n");
      printf("          You have to use option -l due the other "
             "new-line-commands \033[3mhtop\033[0m uses:\n");
      printf("\n");
      printf("            \033[1;3;33m$\033[0m echo q | htop | "
             "\033[1maha\033[0m -b -l > htop.html\n");
      printf("\n");
      printf("          Create an HTML file from the output of this man page. "
             "\033[3mman\033[0m uses bold\n");
      printf("          and underline formatting from \033[3mnroff\033[0m, "
             "which \033[3mul\033[0m converts to SGR:\n");
      printf("\n");
      printf("            \033[1;3;33m$\033[0m MAN_KEEP_FORMATTING=1 "
             "COLUMNS=80 man \033[1maha\033[0m | ul | \033[1maha\033[0m > "
             "man-\033[1maha\033[0m.html\n");
      printf("\n");
      printf("Copyleft \033[1;32mAlexander Matthes\033[0m aka "
             "\033[4mZiz\033[0m " AHA_YEAR "\n");
      printf("         \033[5;36mziz@mailbox.org\033[0m\n");
      printf("         \033[5;36mhttps://github.com/theZiz/aha\033[0m\n");
      printf("This application is subject to the \033[1;34mMPL1.1\033[0m or "
             "\033[1;34mLGPLv2+\033[0m.\n");
      exit(EXIT_SUCCESS);
    } else if ((strcmp(args[p], (char *)"--version") == 0) ||
               (strcmp(args[p], (char *)"-v") == 0)) {
      VERSION_PRINTF_MAKRO
      exit(EXIT_SUCCESS);
    } else if ((strcmp(args[p], "--title") == 0) ||
               (strcmp(args[p], "-t") == 0)) {
      if (p + 1 >= argc) {
      ...
      opts.title = args[p + 1];
      p++;
    } else if ((strcmp(args[p], "--line-fix") == 0) ||
               (strcmp(args[p], "-l") == 0)) {
      opts.htop_fix = 1;
    } else if ((strcmp(args[p], "--no-header") == 0) ||
               (strcmp(args[p], "-n") == 0)) {
      opts.no_header = 1;
    } else if ((strcmp(args[p], "--word-wrap") == 0) ||
               (strcmp(args[p], "-w") == 0))
      opts.word_wrap = 1;
    else if ((strcmp(args[p], "--black") == 0) || (strcmp(args[p], "-b") == 0))
      opts.colorscheme = SCHEME_BLACK;
    else if ((strcmp(args[p], "--pink") == 0) || (strcmp(args[p], "-p") == 0))
      opts.colorscheme = SCHEME_PINK;
    else if ((strcmp(args[p], "--stylesheet") == 0) ||
             (strcmp(args[p], "-s") == 0))
      opts.stylesheet = 1;
    else if ((strcmp(args[p], "--iso") == 0) || (strcmp(args[p], "-i") == 0)) {
      if (p + 1 >= argc) {
    ...
    } else if ((strcmp(args[p], "--no-xml") == 0) ||
               (strcmp(args[p], "-x") == 0))
      opts.no_xml = 1;
    else if ((strcmp(args[p], "--lang") == 0) || (strcmp(args[p], "-L") == 0)) {
      if (p + 1 >= argc) {
      ...
      opts.css = args[p + 1];
      p++;
    } else if ((strcmp(args[p], "--ignore-cr") == 0) ||
               (strcmp(args[p], "-r") == 0))
      opts.ignore_cr = 1;
    else if ((strcmp(args[p], "--style") == 0) ||
             (strcmp(args[p], "-y") == 0)) {
      if (p + 1 >= argc) {
...
enum ColorMode { MODE_3BIT, MODE_8BIT, MODE_24BIT };
...
void printHeader(const struct Options *opts) {
  ...
  if (opts->iso > 0)
    snprintf(encoding, sizeof(encoding), "ISO-8859-%i", opts->iso);
  ...
  if (opts->no_xml)
    ...
    printf("<?xml version=\"1.0\" encoding=\"%s\" ?>\n<!DOCTYPE html PUBLIC "
           ...
           encoding);
  printf("<!-- This file was created with the aha Ansi HTML Adapter. "
  ...
  if (opts->no_xml) {
    ...
    printf("<head>\n<meta http-equiv=\"Content-Type\" "
           "content=\"application/xml+xhtml; charset=%s\"/>\n",
           encoding);
  }
  printf("<title>");
  printHtml(opts->title      ? opts->title
  ...
  if (opts->stylesheet) {
    ...
    case SCHEME_BLACK:
      printf("body         {color: white; background-color: black;}\n");
      ...
      break;
    case SCHEME_PINK:
      printf("body         {background-color: pink;}\n");
  ...
  if (opts->word_wrap) {
    ...
    printf("white-space: -pre-wrap; white-space: -o-pre-wrap; word-wrap: "
           "break-word;}\n");
  }
  ...
  if (opts->stylesheet) {
    ...
    printf("<body");
    if (opts->bodystyle || opts->colorscheme == SCHEME_BLACK ||
        opts->colorscheme == SCHEME_PINK) {
      int styles = 0;
      printf(" style=\"");
      if (opts->colorscheme == SCHEME_BLACK) {
...
int main(int argc, char *args[]) {
  ...
  char *fcstyle[10] = {
      ...
      opts.stylesheet                    ? "green "
      : opts.colorscheme == SCHEME_BLACK ? "color:lime;"
                                         : "color:green;", // Green
      opts.stylesheet                    ? "yellow "
      : opts.colorscheme == SCHEME_BLACK ? "color:yellow;"
                                         : "color:olive;", // Yellow
      opts.stylesheet                    ? "blue "
      : opts.colorscheme == SCHEME_BLACK ? "color:#3333FF;"
                                         : "color:blue;", // Blue
      opts.stylesheet                    ? "purple "
      : opts.colorscheme == SCHEME_BLACK ? "color:fuchsia;"
                                         : "color:purple;", // Purple
      opts.stylesheet                    ? "cyan "
      : opts.colorscheme == SCHEME_BLACK ? "color:aqua;"
                                         : "color:teal;", // Cyan
      opts.stylesheet                    ? "white "
      : opts.colorscheme == SCHEME_BLACK ? "color:white;"
                                         : "color:gray;", // White
      opts.stylesheet                    ? "inverted "
      : opts.colorscheme == SCHEME_BLACK ? "color:black;"
      : opts.colorscheme == SCHEME_PINK  ? "color:pink;"
                                         : "color:white;", // Background
      opts.stylesheet                    ? "reset "
      : opts.colorscheme == SCHEME_BLACK ? "color:white;"
  ...
  char *bcstyle[10] = {
      ...
      opts.stylesheet                    ? "bg-green "
      : opts.colorscheme == SCHEME_BLACK ? "background-color:lime;"
                                         : "background-color:green;", // Green
      opts.stylesheet                    ? "bg-yellow "
      : opts.colorscheme == SCHEME_BLACK ? "background-color:yellow;"
                                         : "background-color:olive;", // Yellow
      opts.stylesheet                    ? "bg-blue "
      : opts.colorscheme == SCHEME_BLACK ? "background-color:#3333FF;"
                                         : "background-color:blue;", // Blue
      opts.stylesheet                    ? "bg-purple "
      : opts.colorscheme == SCHEME_BLACK ? "background-color:fuchsia;"
                                         : "background-color:purple;", // Purple
      opts.stylesheet                    ? "bg-cyan "
      : opts.colorscheme == SCHEME_BLACK ? "background-color:aqua;"
                                         : "background-color:teal;", // Cyan
      opts.stylesheet                    ? "bg-white "
      : opts.colorscheme == SCHEME_BLACK ? "background-color:white;"
                                         : "background-color:gray;", // White
      opts.stylesheet                    ? "bg-reset "
      : opts.colorscheme == SCHEME_BLACK ? "background-color:black;"
      : opts.colorscheme == SCHEME_PINK
          ? "background-color:pink;"
          : "background-color:white;", // Background
      opts.stylesheet ? "bg-inverted "
      : opts.colorscheme == SCHEME_BLACK
  ...
  while ((c = fgetc(fp)) != EOF) {
    if (c == '\033') {
                    ...
                    // https://en.wikipedia.org/wiki/ANSI_escape_code#Colors
      {
        ...
        case 'm':
          ...
          while (momelem != NULL) {
            ...
            case 38: // 3X - Set foreground color
            {
              ...
              if (negative != 0)
                dest = &(state.bc);
              if (momelem->value == 38 && momelem->next &&
              ...
              } else if (momelem->value == 38 && momelem->next &&
                         ...
                         momelem->next->next) // 38;2;<n> -> 24 Bit
              {
                ...
                if (r && g && b) {
                  ...
                  *dest = (r->value & 255) * 65536 + (g->value & 255) * 256 +
                          (b->value & 255);
                }
              } else {
            ...
            case 48: // 4X - Set background color
            {
              ...
              if (negative != 0)
                dest = &(state.fc);
              if (momelem->value == 48 && momelem->next &&
                  momelem->next->value == 5 &&
              ...
              } else if (momelem->value == 48 && momelem->next &&
                         momelem->next->value == 2 &&
        ...
        {
          // If old state was different than the default one, close the current
          // <span>
          ...
          if (statesDiffer(&state, &default_state)) {
            ...
            if (opts.stylesheet && state.fc_colormode != MODE_3BIT &&
    ...
    } else if (c == 13 && opts.htop_fix) {
      for (; line < 80; line++)
        printf(" ");
      line = 0;
      momline++;
      printf("\n");
    } else if (c == 13 && opts.ignore_cr) {
    } else if (c != 8) {
      line++;
      if (opts.line_break) {
        printf("\n");
...
#pragma GCC diagnostic pop
  ...
  // If current state is different than the default, there is a <span> open -
  // close it
  if (statesDiffer(&state, &default_state))
    printf("</span>");
